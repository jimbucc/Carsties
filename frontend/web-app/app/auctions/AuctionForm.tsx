  ...
  return (
    <form className='flex flex-col mt-3' onSubmit={handleSubmit(onSubmit)}>
        ...
        <>
            ...
            <div className='grid grid-cols-2 gap-3'>
                <Input label='Reserve Price (enter 0 if no reserve)' name='reservePrice' control={control} type='number' rules={{required: 'Reserver Price is required'}}/>    
                <DateInput 
